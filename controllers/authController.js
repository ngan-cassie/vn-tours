...
const createSendToken = (user, statusCode, res) => {
    ...
    const cookieOptions = {
        ...
        // secure: true - use https, activate in prod
        httpOnly: true // receive & store cookie -> send it to other reqs
    }
...
exports.resetPassword = catchAsync(async (req,res,next) => {
    ...
    // 4) Log the new user in, send JWT
    createSendToken(user, 200, res); 
})
...
exports.updatePassword = catchAsync(async (req,res,next) => {
    ...
    // compare the current pass with the one in database
